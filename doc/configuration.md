    ...
    append:
      - source: http://example.com/test1
        verification:
          hash:
            function: sha512
            sum:      bc87fc96097a936562f9427a95e3f22b1b9a37f49f08ed3dcf6ca67cf729d85b477c6a0d37219323c3984336747be94659629338de8002c4669a28ae054c34b8
    replace:
  ...
  files:
    ...
    - filesystem: filesystem2
      ...
      contents:
        remote:
          compression: gzip
          url: http://example.com/working-set.db
          verification:
            hash:
              function: sha512
              sum: bc87fc96097a936562f9427a95e3f22b1b9a37f49f08ed3dcf6ca67cf729d85b477c6a0d37219323c3984336747be94659629338de8002c4669a28ae054c34b8
...
passwd:
  users:
    - name:          dev
      password_hash: Pn/a8xxYqaERc
      ssh_authorized_keys:
        - ssh-rsa  core@example.com
      create:
        uid:            1001
        gecos:          Carly Container,1-800-CONTAINERS,carly@container.com
        home_dir:       /home/dev
        no_create_home: true
        primary_group:  dev
        groups:
  ...
  groups:
    - name: admins
      gid: 1010
      password_hash: rzjcKffiBZYAs
etcd:
  version:                     3.0.15
  advertise_client_urls:       "10.0.0.2:2379"
  initial_advertise_peer_urls: "10.0.0.2:2380"
  listen_client_urls:          "http://0.0.0.0:2379"
  listen_peer_urls:            "http://10.0.0.2:2380"
  initial_cluster:             "%m=http://10.0.0.2:2380"
flannel:
  version:        0.7.0
  etcd_endpoints: "http://10.0.0.2:2380"
  interface:      enp25s0
docker:
  flags:
